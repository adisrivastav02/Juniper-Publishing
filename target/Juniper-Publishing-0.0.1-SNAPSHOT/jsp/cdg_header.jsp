...
<li class="nav-item">
   <a class="nav-link" data-toggle="collapse" href="#publishing" aria-expanded="false" aria-controls="publishing"> <span class="menu-title">Data Publishing</span> <i class="menu-arrow"></i> <i class="mdi mdi-database-plus  menu-icon"></i> </a> 
   <div class="collapse" id="publishing">
      <ul class="nav flex-column sub-menu">
         <li class="nav-item"> <a class="nav-link" href="/publishing/publishingAddMetaData"> Onboard Feed </a></li>
         <li class="nav-item"> <a class="nav-link" href="/publishing/editMetadataHome">Edit DataType Mapping </a></li>
         <li class="nav-item"> <a class="nav-link" href="/publishing/reconDashboard">Recon Dashboard</a></li>
      </ul>
   </div>
</li>
        </ul>

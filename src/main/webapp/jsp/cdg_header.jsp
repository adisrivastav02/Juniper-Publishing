  ...
  <div class="container-scroller">
   ...
   <div class="collapse" id="admin">
      <ul class="nav flex-column sub-menu">
         <li class="nav-item"> <a class="nav-link" href="/admin/onboardProject"> Add Project </a></li>
         <li class="nav-item"> <a class="nav-link" href="/admin/SystemOnboard"> Add System </a></li>
         <li class="nav-item"> <a class="nav-link" href="/admin/userOnboarding"> Add User </a></li>
         <li class="nav-item"> <a class="nav-link" href="/admin/usertogrplink"> Add User to a Group </a></li>
      </ul>
   </div>
</li>
        </ul>
